...
The UI was designed using QT so the client consists of a couple of UI files and their respective Python implementations. The Python files are autogenerated and then heavily modified to achieve the desired client implementation.

### day_schedule.ui and day_schedule.py:
